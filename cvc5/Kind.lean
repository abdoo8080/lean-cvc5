...
def listAll : List Kind := [
  ...
  Kind.BITVECTOR_SGT,
  Kind.BITVECTOR_SGE,
  Kind.BITVECTOR_ULTBV,
  Kind.BITVECTOR_SLTBV,
  Kind.BITVECTOR_ITE,
  Kind.BITVECTOR_REDOR,
  Kind.BITVECTOR_REDAND,
  Kind.BITVECTOR_NEGO,
  Kind.BITVECTOR_UADDO,
  Kind.BITVECTOR_SADDO,
  Kind.BITVECTOR_UMULO,
  Kind.BITVECTOR_SMULO,
  Kind.BITVECTOR_USUBO,
  Kind.BITVECTOR_SSUBO,
  Kind.BITVECTOR_SDIVO,
  ...
  Kind.BITVECTOR_TO_NAT,
  Kind.BITVECTOR_UBV_TO_INT,
  Kind.BITVECTOR_SBV_TO_INT,
  Kind.BITVECTOR_FROM_BOOLS,
  Kind.BITVECTOR_BIT,
...
/-- The list of all variants. -/
def listAll : List SortKind := [
  SortKind.INTERNAL_SORT_KIND,
  SortKind.UNDEFINED_SORT_KIND,
  SortKind.NULL_SORT,
  SortKind.ABSTRACT_SORT,
  SortKind.ARRAY_SORT,
  SortKind.BAG_SORT,
  SortKind.BOOLEAN_SORT,
  SortKind.BITVECTOR_SORT,
  SortKind.DATATYPE_SORT,
  SortKind.FINITE_FIELD_SORT,
  SortKind.FLOATINGPOINT_SORT,
  SortKind.FUNCTION_SORT,
  SortKind.INTEGER_SORT,
  SortKind.REAL_SORT,
  SortKind.REGLAN_SORT,
  SortKind.ROUNDINGMODE_SORT,
  SortKind.SEQUENCE_SORT,
  SortKind.SET_SORT,
  SortKind.STRING_SORT,
  SortKind.TUPLE_SORT,
