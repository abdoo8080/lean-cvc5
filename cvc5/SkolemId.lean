...
def listAll : List SkolemId := [
  SkolemId.INTERNAL,
  SkolemId.PURIFY,
  SkolemId.GROUND_TERM,
  SkolemId.ARRAY_DEQ_DIFF,
  SkolemId.BV_EMPTY,
  SkolemId.DIV_BY_ZERO,
  SkolemId.INT_DIV_BY_ZERO,
  SkolemId.MOD_BY_ZERO,
  SkolemId.TRANSCENDENTAL_PURIFY,
  SkolemId.TRANSCENDENTAL_PURIFY_ARG,
  SkolemId.TRANSCENDENTAL_SINE_PHASE_SHIFT,
  SkolemId.ARITH_VTS_DELTA,
  SkolemId.ARITH_VTS_DELTA_FREE,
  SkolemId.ARITH_VTS_INFINITY,
  SkolemId.ARITH_VTS_INFINITY_FREE,
  SkolemId.SHARED_SELECTOR,
  SkolemId.HO_DEQ_DIFF,
  SkolemId.QUANTIFIERS_SKOLEMIZE,
  SkolemId.WITNESS_STRING_LENGTH,
  SkolemId.WITNESS_INV_CONDITION,
  SkolemId.STRINGS_NUM_OCCUR,
  SkolemId.STRINGS_OCCUR_INDEX,
  SkolemId.STRINGS_NUM_OCCUR_RE,
  SkolemId.STRINGS_OCCUR_INDEX_RE,
  SkolemId.STRINGS_OCCUR_LEN_RE,
  SkolemId.STRINGS_DEQ_DIFF,
  SkolemId.STRINGS_REPLACE_ALL_RESULT,
  SkolemId.STRINGS_ITOS_RESULT,
  SkolemId.STRINGS_STOI_RESULT,
  SkolemId.STRINGS_STOI_NON_DIGIT,
  SkolemId.RE_FIRST_MATCH_PRE,
  SkolemId.RE_FIRST_MATCH,
  SkolemId.RE_FIRST_MATCH_POST,
  SkolemId.RE_UNFOLD_POS_COMPONENT,
  SkolemId.BAGS_CARD_COMBINE,
  SkolemId.BAGS_DISTINCT_ELEMENTS_UNION_DISJOINT,
  SkolemId.BAGS_FOLD_CARD,
  SkolemId.BAGS_FOLD_COMBINE,
  SkolemId.BAGS_FOLD_ELEMENTS,
  SkolemId.BAGS_FOLD_UNION_DISJOINT,
  SkolemId.BAGS_CHOOSE,
  SkolemId.BAGS_DISTINCT_ELEMENTS,
  SkolemId.BAGS_DISTINCT_ELEMENTS_SIZE,
  SkolemId.BAGS_MAP_PREIMAGE_INJECTIVE,
  SkolemId.BAGS_MAP_INDEX,
  SkolemId.BAGS_MAP_SUM,
  SkolemId.BAGS_DEQ_DIFF,
  SkolemId.TABLES_GROUP_PART,
  SkolemId.TABLES_GROUP_PART_ELEMENT,
  SkolemId.RELATIONS_GROUP_PART,
  SkolemId.RELATIONS_GROUP_PART_ELEMENT,
  SkolemId.SETS_CHOOSE,
  SkolemId.SETS_DEQ_DIFF,
  SkolemId.SETS_FOLD_CARD,
  SkolemId.SETS_FOLD_COMBINE,
  SkolemId.SETS_FOLD_ELEMENTS,
  SkolemId.SETS_FOLD_UNION,
  SkolemId.SETS_MAP_DOWN_ELEMENT,
  SkolemId.FP_MIN_ZERO,
  SkolemId.FP_MAX_ZERO,
  SkolemId.FP_TO_UBV,
  SkolemId.FP_TO_SBV,
  SkolemId.FP_TO_REAL,
  SkolemId.BV_TO_INT_UF,
  SkolemId.NONE,
]
